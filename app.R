...
df04national_d <- read.dta("gather/clean_data/df04_national_d.dta")
df00national_d <- read.dta("gather/clean_data/df00_national_d.dta")
df00national_r <- read.dta("gather/clean_data/df00_national_r.dta")
df88st_d <- read.dta("gather/clean_data/df88st_d.dta")
