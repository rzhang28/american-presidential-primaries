...
my_names <- c("ID", "voting", 
              ...
              "Lead1", "Trust1", "Experience1", 
              "Judgement1", "Ready1", "Honest1",
              "Lead2", "Trust2", "Experience2", 
              "Judgement2", "Ready2", "Honest2",
              "Lead3", "Trust3", "Experience3", 
...
df08phone[, c("NORMALIZED_FT1", "NORMALIZED_FT2", "NORMALIZED_FT3")] <- 
  t(apply(df08phone[, c("Feeling1", "Feeling2", "Feeling3")],
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure3/df08phone_r_counts.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         df = "df08phone_r") %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure3/df08phone_r_counts_aggregate.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         ...
         race = case_when(
           ...
           WC03_c == "7" ~ "OTHER")) %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/race/naes08_phone_r_race.csv")
...
df_final_2 %>%
  ...
  # Segment respondents by education level.
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/education/naes08_phone_r_education.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         ...
         age = WA02_c) %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/age/naes08_phone_r_age.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/ideology/naes08_phone_r_ideology.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/party_strength/naes08_phone_r_party_strength.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/political_interest/
            naes08_phone_r_political_interest.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            ...
            naes08_phone_r_political_efficacy.csv")
