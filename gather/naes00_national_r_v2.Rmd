...
df00 <- naes00 %>%
  ...
  # Gore*)
  # Ideology cA09, cA28
  # Traits  cA02, cA03, cA04, cA05, cA12, cA13, cA14, cA15
...
df00$Viability1 <- ifelse(is.na(df00$Viability1), 100 - df00$Viability2, df00$Viability1)
df00$Viability2 <- ifelse(is.na(df00$Viability2), 100 - df00$Viability1, df00$Viability2)
