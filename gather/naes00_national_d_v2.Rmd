...
# results before March 7, 2000 (since that is the date before Super Tuesday
# primaries).
...
df00[, c("NORMALIZED_VIABILITY1", "NORMALIZED_VIABILITY2")] <- 
  t(apply(df00[, c("Viability1", "Viability2")], 
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure3/df00_national_d_counts.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         df = "df00_national_d") %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure3/df00_national_d_counts_aggregate.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         ...
         race = case_when(
           ...
           cw03 == "4" ~ "OTHER")) %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/race/naes00_national_d_race.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         ...
         education = case_when(
           ...
           cw06 == "9" ~ "PROFESSIONAL")) %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/education/naes00_national_d_education.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/
            Thesis/Figures/Figure10/age/naes00_national_d_age.csv")
...
df_final_2 %>%
  ...
  mutate(percent = n / sum(n),
         ...
         ideology = case_when(
           ...
           cv04 == "5" ~ "VERYLIBERAL")) %>%
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/
            Figures/Figure10/ideology/naes00_national_d_ideology.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure10/
            party_strength/naes00_national_d_party_strength.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure10/
            political_interest/naes00_national_d_political_interest.csv")
...
df_final_2 %>%
  ...
  write.csv("/Users/ryan/Google Drive/2020_2021/Thesis/Figures/Figure10/
            political_efficacy/naes00_national_d_political_efficacy.csv")
